...
from DiffractiX.linalg import grid_average, solver_direct, solver_complex2real
...
def nl_eq_and_jac(simulation,
	...
	if simulation.pol == 'Ez':
		...
		raise ValueError('DiffractiX doesnt support newton method for Hz polarization yet')		
